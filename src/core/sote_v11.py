"""
SOTE module for IRH v11.0: Self-Organized Topological Extremization functional.

Implements Theorem 4.1 from v11.0: Uniqueness of SOTE as the only
...
class SOTEFunctional:
    ...
    def __init__(self, substrate):
        """Initialize SOTE functional for given substrate."""
        ...
        logger.info(f"SOTE Functional initialized for N={self.N} nodes")
        
    def compute_action(self, W: Optional[sp.csr_matrix] = None,
                      use_cache: bool = True) -> float:
        """
        Compute the SOTE action for given graph.
